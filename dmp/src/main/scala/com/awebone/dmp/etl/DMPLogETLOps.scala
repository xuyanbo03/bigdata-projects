...
object DMPLogETLOps {
  def main(args: Array[String]): Unit = {
    ...
    val lines:RDD[String] = spark.sparkContext.textFile("file:///D:\\workplace\\dmp\\data\\data.txt")
    ...
    /**
      ...
      */
    retDS.write.mode(SaveMode.Overwrite).parquet("file:///D:\\workplace\\dmp\\data\\out\\")
